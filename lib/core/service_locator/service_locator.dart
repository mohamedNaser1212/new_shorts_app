...
import 'package:new_shorts_app/Features/authentication_feature/data/authentication_repo_impl/authentication_repo_impl.dart';
import 'package:new_shorts_app/Features/authentication_feature/domain/authentication_use_case/register_use_case.dart';
import 'package:new_shorts_app/Features/authentication_feature/domain/authentication_use_case/sign_out_use_case.dart';
import 'package:new_shorts_app/Features/authentication_feature/presentation/cubit/login_cubit/login_cubit.dart';
import 'package:new_shorts_app/Features/authentication_feature/presentation/cubit/register_cubit/register_cubit.dart';
import 'package:new_shorts_app/Features/authentication_feature/presentation/cubit/sign_out_cubit/sign_out_cubit.dart';
import 'package:new_shorts_app/Features/comments_feature/data/data_sources/comments_local_data_source.dart';
import 'package:new_shorts_app/Features/comments_feature/domain/comments_use_case/comments_count_use_case.dart';
import 'package:new_shorts_app/Features/comments_feature/domain/comments_use_case/delete_comment_use_case.dart';
import 'package:new_shorts_app/Features/comments_feature/domain/comments_use_case/show_comments_use_case.dart';
import 'package:new_shorts_app/Features/comments_feature/presentation/cubit/add_comments_cubit/add_comments_cubit.dart';
import 'package:new_shorts_app/Features/comments_feature/presentation/cubit/get_comments_cubit/comments_cubit.dart';
import 'package:new_shorts_app/Features/favourites_feature/data/favourites_data_source/favourites_local_data_source.dart';
import 'package:new_shorts_app/Features/favourites_feature/data/favourites_data_source/favourites_remote_data_source.dart';
import 'package:new_shorts_app/Features/favourites_feature/domain/favourites_repo/favourites_repo.dart';
import 'package:new_shorts_app/Features/favourites_feature/domain/favourites_use_case/get_favourites_use_case.dart';
import 'package:new_shorts_app/Features/favourites_feature/domain/favourites_use_case/toggle_favourites_use_case.dart';
...
import 'package:new_shorts_app/Features/profile_feature.dart/data/repo_impl/update_user_data_repo_impl.dart';
import 'package:new_shorts_app/Features/profile_feature.dart/data/repo_impl/user_profile_videos_repo_impl.dart';
...
import 'package:new_shorts_app/Features/profile_feature.dart/domain/use_case/update_user_data_use_case.dart';
import 'package:new_shorts_app/Features/profile_feature.dart/domain/use_case/user_profile_videos_use_case.dart';
import 'package:new_shorts_app/Features/profile_feature.dart/presentation/cubit/follow_cubit/follow_cubit.dart';
import 'package:new_shorts_app/Features/profile_feature.dart/presentation/cubit/update_user_cubit/update_user_data_cubit.dart';
import 'package:new_shorts_app/Features/profile_feature.dart/presentation/cubit/user_profile_cubit/user_profile_cubit.dart';
import 'package:new_shorts_app/Features/search/domain/repo/search_repo.dart';
import 'package:new_shorts_app/Features/search/domain/use_case/search_use_case.dart';
import 'package:new_shorts_app/Features/search/presentation/cubit/search_cubit.dart';
import 'package:new_shorts_app/Features/videos_feature/data/data_sources/video_remote_data_source/videos_rermote_data_source.dart';
import 'package:new_shorts_app/Features/videos_feature/data/data_sources/videos_local_data_source/video_local_data_source.dart';
import 'package:new_shorts_app/Features/videos_feature/data/videos_repo_impl/videos_repo_impl.dart';
import 'package:new_shorts_app/Features/videos_feature/domain/video_repo/video_repo.dart';
import 'package:new_shorts_app/Features/videos_feature/domain/videos_use_cases/get_videos_use_case/get_videos_use_case.dart';
import 'package:new_shorts_app/Features/videos_feature/domain/videos_use_cases/shared_videos_use_case/shared_videos_use_case.dart';
import 'package:new_shorts_app/Features/videos_feature/domain/videos_use_cases/upload_video_use_case/upload_video_use_case.dart';
import 'package:new_shorts_app/Features/videos_feature/presentation/video_cubit/get_videos_cubit/video_cubit.dart';
import 'package:new_shorts_app/Features/videos_feature/presentation/video_cubit/share_video_cubit/share_videos_cubit.dart';
import 'package:new_shorts_app/Features/videos_feature/presentation/video_cubit/upload_videos_cubit/upload_videos_cubit.dart';
import 'package:new_shorts_app/core/network/Hive_manager/hive_helper.dart';
import 'package:new_shorts_app/core/network/Hive_manager/hive_manager.dart';
import 'package:new_shorts_app/core/network/firebase_manager/firebase_helper.dart';
import 'package:new_shorts_app/core/network/firebase_manager/firebase_helper_impl.dart';
...
import 'package:new_shorts_app/core/user_info/data/user_info_data_sources/user_info_remote_data_source.dart';
import 'package:new_shorts_app/core/user_info/domain/user_info_repo/user_info_repo.dart';
